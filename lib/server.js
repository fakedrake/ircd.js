...
Server.prototype = {
  ...
  start: function(callback) {
    ...
    if (this.config.logfile) {
      winston.info("Using file: " + server.config.logfile);
      winston.add(winston.transports.File, { filename: server.config.logfile });
    } else {
      winston.info("No logfile in config, will use winston default.");
    }
